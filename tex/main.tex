...
and behaviours. The testing suits are included in the open code repositories
provided.
}
...
Section~\ref{sec:combined_model}, however parameter validation for this
particular case study is difficult, with all primary data available to us being
used to parametrise the model, still leaving many aspects to be determined by
expert opinion. This expert opinion however was vital in giving a basic
validation of the model, with staff from Ambulans 118 and the 119 Emergency
Ambulance Service in Jakarta approving model results parametrised from their
provided data and expert opinion.}
...
solution aim to push the expected response time above $L$, and once this is
